...
public class Ship 
{
    ...
    /**
     * Generates an array of Ships, initialized to adhere to a Player's fleet
     * 
     * @return an array of Ship objects of size 5, to be used as a Player fleet
     */
    public static Ship[] getListInstance()
    {
      ShipType[] types = ShipType.getAscendingList();
      Ship[] list = new Ship[ types.length ];
      for ( int i = 0; i < list.length; i++ )
        list[i] = getInstance( types[i] );
      return list;
    }

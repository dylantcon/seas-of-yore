 ...
 * 
 * 
 * TODO: Massive rework, decouple Phase-related methods into a PhaseFactory class
 * 
...
public class GameController extends JLayeredPane implements QuadrantListener
{
   ...
   */
  private final int curtainSpeed = 15; // speed of curtain movement

  /**
   * Constructs a new GameController and starts the game.
   *
   * @param salvo          true if the game is in Salvo mode; false otherwise
   * @param returnToTitle  a Runnable thread to return to the title screen
   */
  ...
  {
    curtainTimer = new Timer( 8, ( ActionEvent e ) -> 
    {
